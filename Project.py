...
class Project:
    def __init__(self, video_clip=None, intro_audio=None, outro_audio=None, content_audio_clips=[], master_audio=None, headlines=[], headlines_csv=None, todays_date=date.today(), intro_text="", outro_text=""):
